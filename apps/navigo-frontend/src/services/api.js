...
export const heatmapAPI = {
  ...
  getStations: () => api.get('/heatmap/stations'),
  getCrowdData: () => api.get('/heatmap/crowd'),
  getTaxiData: () => api.get('/heatmap/taxi'),
  getMergedData: () => api.get('/heatmap/merged'),
};

// Booking API
export const bookingAPI = {
  getBookings: () => api.get('/booking/me'),
...
export const hotelAPI = {
  getHotels: (params) => api.get('/ranking', { params }),
